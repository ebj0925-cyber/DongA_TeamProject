...
조은정 개인 기여 자료는 [`JoEunjung_TeamProject`](./JoEunjung_TeamProject/) 폴더에 별도로 정리했습니다.

- 라이브 사이트: https://projectcontact2026.onrender.com/
- Notion: https://app.notion.com/p/C-_-337439bdd4f580c7a8f3d10c81a25347?source=copy_link
- 포트폴리오: `JoEunjung_TeamProject/portfolio/JoEunjung_ProjectContact_Portfolio.pptx`
- 개인 작업일지: `JoEunjung_TeamProject/work-log/JoEunjung_Project_WorkLog.pdf`
- 수행 계획서: `JoEunjung_TeamProject/work-log/JoEunjung_Project_Plan.pdf`
